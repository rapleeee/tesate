    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
      <View>
        <View style={tw`mt-20 p-4`}>
          ...
          <Text style={tw`text-l font-bold mb-4`}>{reactMateriKeuangan[currentMateriIndex].Judul}</Text>
          <Text style={tw`mb-4`}>
          ...
          onPress={handleNext}
          >
            <Text style={tw`text-white text-l text-center`}>{currentMateriIndex === reactMateriKeuangan.length -1 ? "Finish" : "Next"}</Text>
          </Pressable>
        </View>
      </View>
    </SafeAreaView>
