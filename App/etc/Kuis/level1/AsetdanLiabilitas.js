...
const AsetdanLiabilitas = ({ navigation }) => {
  ...
  const handleOptionPress = (pressedOption) => {
    ...
    const isAnswerCorrect =
      reactQuestionsAsetdanLiabilitas[currentQuestionIndex].correctAnswer === pressedOption;
  ...
  return (
    <SafeAreaView style={tw`flex-1`}>
      <ScrollView style={tw`p-4`}>
        ...
        {reactQuestionsAsetdanLiabilitas[currentQuestionIndex].options.map((option) => (
          <Pressable
            key={option}
            style={[
