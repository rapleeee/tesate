    ...
    try {
      ...
      if (currentUser) {
        ...
        if (userDoc.exists()) {
          ...
          // Jika tanggal berbeda, reset dailyXP
          let updatedDailyXP = userData.dailyXP?.value || 0;
          if (lastDailyXPUpdate !== today) {
            updatedDailyXP = 0; // Reset XP harian
            await updateDoc(userDocRef, {
              dailyXP: {
                date: today,
                value: 0, // Simpan reset XP harian ke Firestore
              },
            });
          }
          ...
          setDailyXP(updatedDailyXP || 0); // Set dailyXP ke state
        }
      }
    } catch (error) {
          ...
          <View style={tw`flex-col p-6 mt-4`}>
            <View style={tw`flex-row items-center justify-between  `}>
              <View style={tw`flex-col  gap-2`}>
                <Text style={tw`text-2xl font-bold text-white `}>Selamat Datang,</Text>
              </View>
              ...
              <View style={tw`flex-row `}>
                ...
                <View style={tw`flex-1 mt-4`}>
                  ...
                  <Text style={tw`text-sm text-white mt-2`}>
                    Bawa bisnismu ke level baru bersama Rina, teman perjalanan suksesmu!
                  </Text>
                  <View style={tw`flex-row items-center gap-4 justify-end mt-4`}>
                    <Text style={tw`text-xs text-gray-200`}>Mulai Sekarang</Text>
                    <TouchableOpacity
          ...
          <View style={tw`px-6 mt-6`}>
            ...
            <View style={tw`mt-4`}>
              <View style={tw`flex-row justify-between items-center mb-2`}>
                <Text style={tw`text-lg font-bold text-[#BB1624]`}>Explore Lesson</Text>
                <Text style={tw`text-base text-[#BB1624]`} onPress={() => navigation.navigate('myCourses')}>Lihat semua</Text>
              </View>
              <View style={tw`flex-row flex-wrap justify-between gap-4`}>
                ...
                >
                  <Image
                    ...
                    resizeMode="contain"
                  />
                  <Text style={tw`text-center text-sm text-gray-800 mt-2`} numberOfLines={2}>
            ...
            <View style={tw`mt-4 mb-12`}>
              <Text style={tw`text-lg font-bold text-[#BB1624] mb-4`}>Spesial Untuk Kamu</Text>
              <View
                style={[
              ...
              >
                <View style={tw`flex-row items-center`}>
                  ...
                  <View style={tw`flex-1  items-center`}>
                    <Text style={tw`text-xs text-[#BB1624] text-center `}>Kumpulkan XP dan dapatkan hadiah!</Text>
                    <Text style={tw`text-xl font-bold text-white text-center`}>Ikuti Tantangan Mingguan</Text>
                    <TouchableOpacity
                      style={tw`bg-[#BB1624] mt-2 px-4 py-1 rounded-lg items-center`} onPress={() => navigation.navigate('reward')}
                    >
