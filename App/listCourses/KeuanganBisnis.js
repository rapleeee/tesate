...
import { SafeAreaView, ScrollView, Text, View, Pressable, Modal, Image, TouchableOpacity } from 'react-native';
...
const KeuanganBisnis = () => {
  ...
  const modules = [
    { title: "Fundamentals for Startup Success", duration: "30 minutes", level: 1 },
    { title: "Crafting the Perfect Investor Pitch Guide", duration: "1 hour 20 minutes", level: 2 },
    { title: "Negotiating Deal Terms", duration: "45 minutes", level: 3 },
    { title: "Fueling Growth Strategies", duration: "1 hour 3 minutes", level: 4 },
  ];
  ...
  return (
    <SafeAreaView style={tw`flex-1 bg-white`}>
      <ScrollView contentContainerStyle={tw`flex-grow`}>
        ...
        <View style={tw`p-3`}>
          <Text style={tw`text-base font-bold text-[#BB1624]`}>Introduction of Venture Capital</Text>
          <Text style={tw`text-xs text-gray-600 mt-1`}>
            Learn about the fundamentals of venture capital to empower your startup.
          </Text>
        ...
        <View style={tw`p-3`}>
          {!joined ? (
            <Pressable style={tw`bg-[#BB1624] py-2 rounded-full items-center`} onPress={handleJoinClass}>
              <Text style={tw`text-white text-sm font-semibold`}>JOIN CLASS</Text>
            </Pressable>
          ) : (
            <Text style={tw`text-green-600 text-center`}>Yeayyy!! Kamu udah join kelasnya</Text>
          )}
        </View>
